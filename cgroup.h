...
typedef enum
{
	ERROR_CGROUP_ARGUMENT = -2,
	ERROR_CGROUP_OPERATION
} cgroup_error_code;
 ...
 * - ERROR_CGROUP_ARGUMENT when path is not a cgroup directory.
 * - ERROR_CGROUP_OPERATION when cannot delete cgroup.
 */
