...
// Max length of string representation of descendants number
// (the value is a number of at most two digits + null terminator)
#define MAX_DECS_SIZE 3

// Max length of string representation of depth number
// (the value is a number of at most two digits + null terminator)
