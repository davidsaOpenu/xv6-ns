...
static int pouch_fork(char* container_name, int user_tty, int demonize);
...
void printhelp(){
	printf(2,"usage: pouch_start <name> <--demonize | &>\n");
}
...
main(int argc, char *argv[])
{
  ...
  pouch_fork(container_name, user_tty, demonize);
  exit(0);
}
