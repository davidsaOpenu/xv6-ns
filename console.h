...
//Predefined history here - if adding new commands, update PREDEF_COUNT as well to reflect the correct number.
//Remember maximum number of commands defined in HIST_BUF above.
#define PREDEF_COUNT 1
const char *predef_hist[] = {"cgroupstests"};