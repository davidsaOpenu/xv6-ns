...
// Set the given string length to given val.
static void set_string_in_buf(char* string, int length, char val)
{
...
{
    set_string_in_buf(string, length, 0);
}
