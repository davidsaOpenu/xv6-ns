...
TEST (test_nested_cgroups)
{
  ...
  char min_val[12] = {0};
  //char max_val[12] = {0};
  char current_nested_cgroup[256] = {0};
  ...
  printf(1, "current_nested_cgroup path: %s\n", current_nested_cgroup);
  ...
  printf(1, "temp_path_g mem controller: %s\n", temp_path_g);
